...
<div class="page-inner mt--5">
	<div class="row">
				...
				<div class="card-body ">
					<div class="row align-items-center">
						...
						<div class="col col-stats ml-3 ml-sm-0">
							<div class="numbers">
							<a href=""><p class="card-category">USERS</p></a>
			...
			<div class="card card-stats card-round">
				<div class="card-body">
					<div class="row align-items-center">
						...
						<div class="col col-stats ml-3 ml-sm-0">
							<div class="numbers">
							<a href=""><p class="card-category">MENU</p></a>
							<h4 class="card-title"></h4>
								<a href="">LEAR MORE</a>
							</div>
						</div>
			...
			<div class="card card-stats card-round">
				<div class="card-body">
					<div class="row align-items-center">
						...
						<div class="col col-stats ml-3 ml-sm-0">
							<div class="numbers">
							<a href=""><p class="card-category">REPORT TRANSACTION</p></a>
							<h4 class="card-title"></h4>
								<a href="">LEAR MORE 111111111111</a>
							</div>
						</div>
					</div>
		...
		<!-- g</h5><div class="col-sm-6 col-md-3">
			<div class="card card-stats card-round">
				<div class="card-body">
					<div class="row align-items-center">
						<div class="col-icon">
