                        ...
                        <div class="table-responsive">
                                <form action="{{route('dapur.update',$dapur->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <label for="stan">Stan</label>
                                        <input type="text" class="form-control " name="stan"id="stan" value="{{$dapur->stan}}" >
                                    </div>
                                    <div class="form-group">
                                    <label for="head_koki">Head Koki</label>
                                        <input type="text" class="form-control" id="head_koki" value="{{$dapur->head_koki}}"name="head_koki">
                                    </div>
