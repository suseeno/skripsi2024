                        ...
                        <div class="table-responsive">
                                 <form action="{{route('about.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                  ...
                                  <br>
                                        ...
                                        <img src="{{asset('uploads/'.$data->image)}} "width="70" alt="">
                                        </br>
                                    </div> 
                                    <div class="form-group">
                                    <label for="title">Title</label>
                                        <input type="text" class="form-control" id="text"name="title" placeholder="Masukkam Title" value="{{$data->title}}">
                                    </div>
                                    <div class="form-group">
                                    <label for="description">Description</label>
	                                        <textarea class="form-control" id="editor1"  name="description"rows="5">{{$data->description}}
												</textarea>
                                    </div>
