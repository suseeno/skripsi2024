...
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    if ($hour >= 0 && $hour <= 11) {
        echo 'Selamat Pagi Selamat Datang di D Rasa Caffe';
    } elseif ($hour >= 12 && $hour <= 14) {
        echo 'Selamat Siang Selamat Datang di D Rasa Caffe';
    } elseif ($hour >= 15 && $hour <= 17) {
        echo 'Selamat Sore Selamat Datang di D Rasa Caffe';
    } elseif ($hour >= 17 && $hour <= 18) {
        echo 'Selamat Petang Selamat Datang di D Rasa Caffe';
    } elseif ($hour >= 19 && $hour <= 23) {
        echo 'Selamat Malam Selamat Datang di D Rasa Caffe';
    }
    ?>, 
	    </h1>
...
<div class="container" id="menu">
	...
	<h2 class="text-center my-3"> Menu D'rasa</h2>
	...
	<?php $kategori = App\Models\CategoryMenu::get(); ?>
				  ...
				  <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				    ...
				    <div class="dropdown-menu">
					 ...
					 @foreach($kategori as $dt)
					  <a class="dropdown-item category" href="{{route('show.category', $dt->id)}}">{{$dt->name_category}}</a>
					@endforeach  
  ...
  @if(session('result') == 'success')
	<div class="alert alert-success alert-dismissible fade show" role="alert">
	  <strong>1 Item Ditambahkan!</strong> Anda Telah Menambahkan Item Ke Keranjang Anda. <strong>Ayo Pesan Lagi.</strong> Atau Mau <span class="oi oi-arrow-thick-right"></span> <a href="{{route('shoping-cart')}}" class="btn btn-success btn-sm"><span class="oi oi-cart"></span> Lihat Keranjang</a>
	...
	<div class="row">
		...
		<div class="col-md-4 pb-4">
			<div class="card-group">
			  <div class="card">
                    <img src="{{ asset('uploads/'.$dt->image) }}" alt="...">
			    <div class="card-body">
              ...
              echo "<span class='badge badge-danger'>draf</span>";
          } ?>
			      </p>
				  <p class="card-text">{{$dt->description}}</p>
			      <p class="card-text">Rp.{{number_format($dt->price,0,',','.')}},</p>
			    </div>
			    <div class="card-footer">
			    	@if($dt['is_active']=='1')
			      		<a href="{{route('add.cart', $dt->id)}}" class="btn btn-success btn-block"><span class="oi oi-cart"></span> Pesan</a>
			        @else
