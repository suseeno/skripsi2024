	...
	@if(Session::has('cart'))
		...
		<div class="row">
			...
			<div class="col-md-9 mx-auto">
				<a href="" class="btn btn-danger cancel mr-2 mb-2"><span class="oi oi-trash"></span> Batal Memesan</a><a class="btn btn-success mb-2" href="{{route('menu-masakan')}}"><span class="oi oi-arrow-circle-left"></span> Pesan Menu Lagi</a>
					...
					<table class="table">
					  ...
					  <tbody>
					    ...
					    <tr>
					      ...
					      <td>
					      	<img src="{{asset('uploads/'.$dt['item']['image'])}}" alt="Gambar Masakan" class="img-thumnail" width="50px">
					      </td>
					      <td>{{$dt['item']['name']}}</td>
					      <td>Rp.{{number_format($dt['item']['price'],0,',','.')}},</td>
					      <td>
